...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    #Sender Who I Request Money From him Data
    ...
    if (!validate($amount, 'required')) {
        ...
        $errors['Amount'] = "This Email Balance Is Not Enough Try low Amount";
    }
    ...
    else
    {
        ...
        $sql = "insert into transactions (user_sender_id,user_receiver_id,type,amount,reason) values ($senderID,$receiverID,'withdraw', $amount,'$reason')";
        $op  = doQuery($sql);
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Request Money</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">
                       <?php
                       # Print Messages ....
                       Messages('Dashboard / Request Money');
                       ?>
                ...
                <div class="row">
                   <div class="col-md-12">
                       <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                           <div class="form-row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label class="small mb-1" for="inputFirstName">Request From This Sender Email</label>
                           ...
                           <button class="form-control btn btn-primary btn-block">Request Money</button>
